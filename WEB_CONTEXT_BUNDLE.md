...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.53-kirby-problem-3.53-bad81660-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.53"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.53-kirby-problem-3.53-bad81660-v1",
      "problem_contract_sha256": "e40b1605f376876f15a1dcc23d2b1303e75d4930a47781e2d628daf0ea459260",
      "problem_id": "problem:um-kp-3.53-kirby-problem-3.53-bad81660",
      "route_id": "route:um-kp-3.53-kirby-problem-3.53-bad81660-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.53-kirby-problem-3.53-bad81660-source-fidelity-01",
      "graph_id": "graph:um-kp-3.53-kirby-problem-3.53-bad81660-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.53-kirby-problem-3.53-bad81660-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.53-kirby-problem-3.53-bad81660-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Are all strong L-spaces branched double covers of alternating links in $S^3$?"
          },
          "statement_sha256": "1e4cbb8a4aa68bcdcc84e81a3add03c715eadf438c0d056c68ddc2e8be17bb87"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.53-kirby-problem-3.53-bad81660-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.53-kirby-problem-3.53-bad81660-root",
      "route_id": "route:um-kp-3.53-kirby-problem-3.53-bad81660-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.53-fe601b5011e9",
        "url": "https://www.unsolvedmath.com/problems/KP-3.53"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
